...
const VideoMenu = ({isShow,isFullScreen,setClickMenu,isCameraActive,isMicrophoneOpen,isWhiteBoardActive,isScreenOpen}) => {

  return (
    <div className={"position-absolute "+styles.videoMenu+" "+(isShow?styles.menuShow:"")}>
        <div className={'ps-3 px-3 gap-3 '+styles.menuItems+" "}>
          <VideoMenuIcon isActive={isWhiteBoardActive} index={0} onClick={setClickMenu} hoverText={"Whiteboard"}  icon={"pencil-square"}></VideoMenuIcon>
          <VideoMenuIcon isActive={isCameraActive} index={1} onClick={setClickMenu} hoverText={"Camera"} icon={"camera-video-fill"}></VideoMenuIcon>
          <VideoMenuIcon isActive={isScreenOpen} index={2} onClick={setClickMenu} hoverText={"Screen Share"} icon={"projector-fill"}></VideoMenuIcon>
          ...
          <VideoMenuIcon isActive={isMicrophoneOpen} index={6} onClick={setClickMenu} hoverText={"Microphone"} icon={"mic"}></VideoMenuIcon>
